      ...
      <div class="row">
        <div class="article">
          <div class="card card-signin my-5">
            <div class="card-body">
              <h5 class="card-title text-center">Stadium</h5>
            ...
            // output data of each row
					  while($row = $result->fetch_assoc()) {
						echo "<hr class='my-4'> <b>Stadium ID: </b> " . $row["StadiumID"]. "<br><b>City: </b> " . $row["City"]. "<br><b>Name: </b> " . $row["Name"]. "<br><b>Number: </b> " . $row["Number"];
					  }
					} else {
					  echo "No result";
					}
