          ...
          <div class="card card-signin my-5">
            ...
            // output data of each row
					  while($row = $result->fetch_assoc()) {
						echo "<hr class='my-4'> <b>Ticket ID: </b> " . $row["TicketID"]. "<br><b>Customer ID: </b> " . $row["CustomerID"]. "<br><b>Stadium ID: </b> " . $row["StadiumID"]. "<br><b>Discount ID: </b> " . $row["DiscountID"]. "<br><b>Match ID: </b> " . $row["MatchID"];
					  }
					} else {
					  echo "No result";
					}
