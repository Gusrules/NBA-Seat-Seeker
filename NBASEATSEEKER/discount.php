      ...
      <div class="row">
        <div class="article">
          <div class="card card-signin my-5">
            <div class="card-body">
              <h5 class="card-title text-center">Discounts</h5>
            ...
            // output data of each row
					  while($row = $result->fetch_assoc()) {
						echo "<hr class='my-4'> <b>Discount ID: </b> " . $row["DiscountID"]. "<br><b>Discount Name: </b> " . $row["DiscountName"]. "<br><b>Discount Price: </b>" . $row["DiscountPrice"];
					  }
					} else {
					  echo "No Result";
					}
